...
CUDA_VISIBLE_DEVICES=0 python text2nerf_main.py --config 'configs/text2nerf_scenes.txt' --basedir '/home/nerf/text2nerf_circle' --frame_select_type 'auto_cos' --expname 'text000_360' --prompt 'an empty closed room' --n_stage1 200 --n_stage2 200 --datadir 'data_example/text000' --pose_traj 'circle' --regen_pose
